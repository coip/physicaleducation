...
func products(x, y int) (e, s, se, sw int) {
	e, s, se, sw = grid[x][y], grid[x][y], grid[x][y], grid[x][y]
...
func main() {
	...
	grid = [23][26]int{
		...
		{0, 0, 0, 52, 70, 95, 23, 4, 60, 11, 42, 69, 24, 68, 56, 1, 32, 56, 71, 37, 02, 36, 91, 0, 0, 0},
		{0, 0, 0, 22, 31, 16, 71, 51, 67, 63, 89, 41, 92, 36, 54, 22, 40, 40, 28, 66, 33, 13, 80, 0, 0, 0},
		{0, 0, 0, 24, 47, 32, 60, 99, 3, 45, 02, 44, 75, 33, 53, 78, 36, 84, 20, 35, 17, 12, 50, 0, 0, 0},
		...
		{0, 0, 0, 86, 56, 0, 48, 35, 71, 89, 07, 5, 44, 44, 37, 44, 60, 21, 58, 51, 54, 17, 58, 0, 0, 0},
